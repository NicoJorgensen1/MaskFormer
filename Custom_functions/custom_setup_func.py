...
parser.add_argument("--early_stop_patience", type=int, default=10, help="The number of epochs to accept that the model hasn't improved before terminating training. Default: 10")
