...
parser.add_argument("--batch_size", type=int, default=12, help="The batch size used for training the model. Default: 1")
...
parser.add_argument("--num_epochs", type=int, default=125, help="The number of epochs to train the model for. Default: 1")
...
parser.add_argument("--patience", type=int, default=4, help="The number of epochs to accept that the model hasn't improved before lowering the learning rate by a factor '--lr_gamma'. Default: 6")
