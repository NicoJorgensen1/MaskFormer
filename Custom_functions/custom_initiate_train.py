...
if FLAGS.inference_only == False:
    ...
    for epoch in range(FLAGS.num_epochs):                                           # Iterate over the chosen amount of epochs
        ...
        shutil.copyfile(os.path.join(cfg.OUTPUT_DIR, "metrics.json"),               # Rename the metrics.json to metricsX.json ...
        ...
        cfg.SOLVER.BASE_LR = cfg.SOLVER.BASE_LR * 0.9                               # Lower the learning right just a little
        ...
        # cfg = keepAllButLatestAndBestModel(cfg=cfg, history=history, FLAGS=FLAGS)
...
# Save the history dictionary after training
SaveHistory(historyObject=history, save_folder=cfg.OUTPUT_DIR)
